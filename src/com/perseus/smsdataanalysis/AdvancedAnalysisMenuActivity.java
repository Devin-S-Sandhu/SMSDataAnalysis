...
public class AdvancedAnalysisMenuActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.advanced_activity_analysis_menu);
		...
		analysisType.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			private String[] analysisDescriptions = AdvancedAnalysisMenuActivity.this
	...
	private DatePickerDialog.OnDateSetListener startDatePickerListener = new DatePickerDialog.OnDateSetListener() {
		...
		public void onDateSet(DatePicker view, int selectedYear,
			...
			if ((selectedYear > end_year)
				...
				Toast.makeText(AdvancedAnalysisMenuActivity.this,
	...
	public void analyze(View view) {
		Intent myIntent = new Intent(AdvancedAnalysisMenuActivity.this,
		...
		AdvancedAnalysisMenuActivity.this.startActivity(myIntent);
	}

	public void doLaunchContactPicker(View view) {
		Intent intent = new Intent(AdvancedAnalysisMenuActivity.this, MultipleContactPickerActivity.class);
